...
AliHelix::AliHelix(const AliExternalTrackParam &t)
{
  ...
  //PH Sometimes fP4 and fHelix[4] are very big and the calculation
  //PH of the Sqrt cannot be done. To be investigated...
  //fHelix[4]=fHelix[4]/(-1000/0.299792458/AliTracker::GetBz());    // C  TODO
  fHelix[4]=fHelix[4]/(-1000/0.299792458/GetBz());    // C  TODO
  //  cs=TMath::Cos(alpha); sn=TMath::Sin(alpha);
  cs=cosf(alpha); sn=sinf(alpha); // RS use float versions: factor 2 in CPU speed
...
AliHelix::AliHelix(Double_t x[3], Double_t p[3], Double_t charge, Double_t conversion)
{
  ...
  if (TMath::Abs(conversion)<0.00000001) 
    //conversion = -1000/0.299792458/AliTracker::GetBz(); //TODO
  conversion = -1000/0.299792458/GetBz(); //TODO
  //
  //  
...
void  AliHelix::GetMomentum(Double_t phase, Double_t p[4],Double_t conversion, Double_t *xr) const
{
  ...
  //if (TMath::Abs(conversion)<0.0001) conversion = TMath::Abs(1./kB2C/AliTracker::GetBz()); //TODO
